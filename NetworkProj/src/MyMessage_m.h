...
class MyMessage_Base : public ::omnetpp::cPacket
{
  ...
  public:
    ...
    //extras
    virtual int getChcount() const;
    virtual void setChcount(int chcount);

    virtual void set_sender(int senderss){Sender_s = senderss;}
    virtual void set_reciever(int recievers){Reciever_s = recievers;}
    virtual int get_sender(){return Sender_s;}
    virtual int get_reciever(){return Reciever_s;}
